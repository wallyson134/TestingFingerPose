...
const gestureStrings = {
  ...
  'O':'O',
  'U':'U',
  'Nome_Gesture':'Nome_Gesture',
  'Casa_Gesture':'Casa_Gesture',
  ...
  const estimateHands = async () => {
    ...
    for (const hand of hands) {
      ...
      if (predictions.gestures.length > 0) {
        ...
        if (result.name === 'LIBRAS_Obrigado') {
          resultLayer[chosenHand].innerText = "Obrigado"; // Ou qualquer outra ação que você queira realizar
          continue;
        }
